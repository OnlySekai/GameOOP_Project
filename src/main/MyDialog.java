...
public class MyDialog extends JDialog{
    ...
    public void addINFOGroup(){
        ...
        j.setText("NGUYỄN KHÁNH AN\nVŨ VIỆT BÁCH\nNGUYỄN MẠNH CƯỜNG\nNGUYỄN MINH TUẤN\nNGUYỄN VĂN KIÊN");
        j.setEditable(false);
        add(j);
        j.setBounds(0,0,320,240);
        j.setFont(new Font("Consolas",Font.BOLD,30));
    }
    public void addJTextFieldSound(){
        ...
        jTextField.setFont(new Font("Default",Font.BOLD,20));
        add(jTextField);
    ...
    public void addJTextFieldSound2(){
        ...
        jTextField2.setFont(new Font("Default",Font.BOLD,20));
        add(jTextField2);
